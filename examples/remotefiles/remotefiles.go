...
func main() {
	...
	r, err := os.Open("stevejones-softwaredev.png")
	if err != nil {
		fmt.Printf("%s\n", err)
		return
	}
	...
	remotefile, err := api.AddRemoteFile(slack.RemoteFileParameters{
		ExternalID:            "stevejones-softwaredev",
		ExternalURL:           "https://github.com/stevejones-softwaredev/slack",
		Title:                 "stevejones-softwaredev",
		Filetype:              "go",
		IndexableFileContents: "golang, slack",
		// PreviewImage:          "stevejones-softwaredev.png",
